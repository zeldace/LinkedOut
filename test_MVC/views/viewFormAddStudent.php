    ...
    <main class="form-signin">
        <form action="AddStudent" method="POST">
          ...
          <div class="form-floating">
            ...
            <input type="text" class="form-control" id="floatingInput"  name='FirstNameStudent' required>
          </div>
          <div class="form-floating">
            <label for="floatingInput">Last Name</label>
            <input type="text" class="form-control" id="floatingInput"  name='LastNameStudent' required>
          </div>
          <div class="form-floating">
            <label for="floatingInput">Promotion</label>
            <input type="text" class="form-control" id="floatingInput" name='Promotion' required>
          </div>
          <div class="form-floating">
          ...
          <div class="form-floating">
            ...
            <input type="text" class="form-control" id="floatingInput" name='PostalCode' required>
          </div>
          <div class="form-floating">
            <label for="floatingInput">Campus</label>
            <input type="text" class="form-control" id="floatingInput" name='CampusStudent' required>
          </div>
          <div class="form-floating">
            <label for="floatingInput">Username</label>
            <input type="text" class="form-control" id="floatingInput" name='LoginStudent' required>
          </div>
          <div class="form-floating">
            <label for="floatingInput">Password</label>
            <input type="text" class="form-control" id="floatingInput" name='PasswordStudent' required>
          </div>
          <div class="form-floating">
            <input type="hidden" class="form-control" id="floatingInput" name='IdStudent' value=0>
          </div>
          <div class="action">
            <div class="add">
